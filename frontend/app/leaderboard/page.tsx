      ...
      <div style={{ maxWidth:900,margin:"0 auto",padding:"5rem 1.5rem 4rem",position:"relative",zIndex:1 }}>
        ...
        {loading ? (
          ...
          <div style={{ display:"flex",flexDirection:"column",gap:1,background:BORDER,border:`1px solid ${BORDER}` }}>
            {/* Header */}
            <div style={{ background:"rgba(153,69,255,0.06)",padding:"0.75rem 1.25rem",display:"grid",gridTemplateColumns:"40px 1fr auto auto auto",gap:"1rem",alignItems:"center" }}>
          ...
          <div style={{ background:BG2,border:`1px solid ${BORDER}`,padding:"3rem",textAlign:"center" }}>
            ...
            <button onClick={()=>router.push("/")} style={{ background:"linear-gradient(135deg,#9945ff,#627eea)",color:"#fff",border:"none",fontFamily:"var(--font-mono)",fontSize:"0.72rem",fontWeight:700,padding:"0.75rem 1.5rem",cursor:"pointer",letterSpacing:"0.08em",textTransform:"uppercase" }}>
              Analyse a Wallet →
            </button>
          </div>
        )}
