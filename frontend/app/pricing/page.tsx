  ...
  return (
    <main style={{ background:BG,minHeight:"100vh",color:TEXT,fontFamily:"var(--font-mono)" }}>
      ...
      <div style={{ maxWidth:600,margin:"0 auto",padding:"8rem 1.5rem 4rem",position:"relative",zIndex:1,textAlign:"center" }}>
        ...
        <div style={{ background:"rgba(96,165,250,0.04)",border:"1px solid rgba(96,165,250,0.25)",borderTop:`2px solid ${ICE}`,padding:"2.5rem",marginBottom:"2rem" }}>
          ...
          <button onClick={()=>router.push("/")} style={{ width:"100%",background:ICE,color:BG,border:"none",fontFamily:"var(--font-mono)",fontSize:"0.78rem",fontWeight:700,padding:"1rem",cursor:"pointer",letterSpacing:"0.08em",textTransform:"uppercase" }}>
            Start Analysing →
          </button>
        </div>
        <div style={{ background:"rgba(96,165,250,0.04)",border:`1px solid ${BORDER}`,padding:"1.5rem",textAlign:"left" }}>
