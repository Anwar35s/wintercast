...
const STATS = [["2.4M+","Wallets","rgba(153,69,255,0.2)","rgba(153,69,255,0.4)","#c084fc"],["30+","Signals","rgba(98,126,234,0.2)","rgba(98,126,234,0.4)","#818cf8"],["8","Archetypes","rgba(247,147,26,0.2)","rgba(247,147,26,0.4)","#fb923c"],["6","Chains","rgba(40,160,240,0.2)","rgba(40,160,240,0.4)","#60a5fa"]]
