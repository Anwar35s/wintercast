...
const NAV = [["/whales","Whales"],["/token","Tokens"],["/track","Track"],["/gas","Gas"],["/leaderboard","Board"],["/copy","Copy"],["/market","📊 Market"],["/battle","⚔️ Battle"],["/hall","🏛️ Hall"],["/compare","Compare"],["/pricing","Pricing"]]
    ...
    <main style={{background:"#0a0520",minHeight:"100vh",color:"#f1f5f9",fontFamily:"var(--font-mono)"}}>
      ...
      <footer style={{maxWidth:1100,margin:"0 auto",padding:"2rem 1.25rem 3rem",borderTop:"1px solid rgba(153,69,255,0.15)",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:"1rem",position:"relative",zIndex:1}}>
        ...
        <div style={{display:"flex",gap:"1.5rem",flexWrap:"wrap"}}>
          {[["/whales","Whales"],["/token","Tokens"],["/track","Track"],["/gas","Gas"],["/leaderboard","Board"],["/copy","Copy"],["/market","📊 Market"],["/battle","⚔️ Battle"],["/hall","🏛️ Hall"],["/battle","Battle"],["/hall","Hall"],["/compare","Compare"],["/pricing","Pricing"],["mailto:hello@wintercast.io","Contact"]].map(([h,l])=><a key={l} href={h} style={{color:"rgba(241,245,249,0.3)",fontSize:"0.65rem",letterSpacing:"0.08em",textDecoration:"none"}}>{l}</a>)}
        </div>
